  ...
  <Svg xmlns="http://www.w3.org/2000/svg" width={204} height={184} fill="none" {...props}>
    <G clipPath="url(#a)">
      ...
      <G mask="url(#b)">
        ...
        />
        <Path fill="url(#j)" d="M173.038 0 156.91 18.287l8.201 9.113L173.038 0Z" opacity={0.7} />
        <Path fill="url(#k)" d="m173.038 0-7.927 27.4 12.322-3.026L173.038 0Z" opacity={0.7} />
        <Path fill="url(#l)" d="m156.91 18.287 5.776 17.503 2.425-8.39-8.201-9.113Z" />
        <Path fill="url(#m)" d="m162.686 35.789 14.746-11.416-12.322 3.026-2.424 8.39Z" />
        <Path
          fill="#fff"
          d="m177.418 24.288-12.279 3.014-8.172-9.081-.057.065 8.201 9.114-2.425 8.39.135-.108 2.39-8.252 12.222-3.056-.015-.086Z"
          opacity={0.5}
        />
        <Path fill="url(#n)" d="m.787 95.427 7.86-11.195 14.387.173-8.065 12.29L.787 95.426Z" />
        <Path fill="url(#o)" d="m0 67.176.787 28.25 14.181 1.268L0 67.176Z" opacity={0.7} />
        <Path fill="url(#p)" d="m0 67.176 14.968 29.518 8.066-12.289L0 67.175Z" opacity={0.7} />
        <Path fill="url(#q)" d="m.787 95.428 18.765 10.304-4.583-9.037L.787 95.428Z" />
        <Path fill="url(#r)" d="m19.552 105.73 3.482-21.326-8.065 12.29 4.583 9.036Z" />
        <Path
          fill="#fff"
