...
const ArrowVertical = () => (
  <Svg width={48} height={48} fill="none">
    ...
    <Path
      fill="#fff"
      d="M23.132 17.125h1.736v10.417l4.774-4.775L30.875 24 24 30.875 17.125 24l1.233-1.233 4.774 4.775V17.125Z"
    />
    <Defs>
      ...
      <LinearGradient id="b" x1={10} x2={38} y1={24} y2={24} gradientUnits="userSpaceOnUse">
